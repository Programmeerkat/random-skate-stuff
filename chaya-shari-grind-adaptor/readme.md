...
* 8x M6 Nylock nuts 
* 8x M6 washers
* 2x M6x20 button head socket cap

## Printing instructions
I've tested these printed with ABS with using a 0.4 mm nozzle, with a 5 bottom layers, 5 top layers, 5 walls, and 50% infill. 
